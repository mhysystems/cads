...
namespace Lmi3d
{
    namespace GoSdk
    {
        ...
        public ref class GoSetup : public KObject
        {
            ...
            /// <summary>The default operation mode of the sensor system.</summary>
            k32s GetLayoutGridDirectionSystemValue(GoRole role)
            {
                return ::GoSetup_LayoutGridDirectionSystemValue(Handle, role);
            }
            ...
            /// <summary>The default operation mode of the sensor system.</summary>
            k32s LayoutGridRowSystemValue(GoRole role)
            {
           ...
           /// <summary>The external input to use for profile triggering - only applicable if trigger source is DigitalInput.</summary>
            ...
            ///
            /// <param name="role">Determines which sensor to apply changes to.</param>
            ...
            ///
            /// <param name="role">The device whose value to retrieve.</param>
            ...
            /// <param name="role">The device role whose advanced settings object to return.</param>
            ...
            /// <param name="role">The device role whose material settings object to return.</param>
