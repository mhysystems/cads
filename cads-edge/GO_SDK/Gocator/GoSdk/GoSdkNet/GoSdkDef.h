...
namespace Lmi3d
{
    namespace GoSdk
    {
        ...
        public value struct GoReplayExportSourceType
        {
            ...
            /// <summary>Intensity data replay export.</summary>
        ...
        public value struct GoToolType
        {
            ...
            /// <summary>Profile X-Line tool.</summary>
            literal k32s ProfileXLine = GO_TOOL_PROFILE_X_LINE;
        ...
        public value struct GoMeasurementType
        {
            ...
            /// <summary>Profile X-Line tool Z measurement.</summary>
            literal k32s ProfileXLineZ = GO_MEASUREMENT_PROFILE_X_LINE_Z;

            /// <summary>Profile X-Line tool Validity measurement.</summary>
            literal k32s ProfileXLineValidity = GO_MEASUREMENT_PROFILE_X_LINE_VALIDITY;
