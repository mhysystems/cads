...
namespace Lmi3d
{
    namespace GoSdk
    {
        namespace Tools
        {
            ...
            public ref class GoSurfaceTool abstract : public GoExtTool
            {
            ...
            public:
                ...
                {
                    virtual GoDataSource get() override { return (GoDataSource)::GoSurfaceTool_Source(Handle); }
                    virtual void set(GoDataSource value) override { KCheck(::GoSurfaceTool_SetSource(Handle, value)); }
                }

                /// <summary>Gets/Sets the current X-anchoring source.</summary>
                property k32s XAnchor
                {
                    virtual k32s get() override { return (k32s)::GoSurfaceTool_XAnchor(Handle); }
                    virtual void set(k32s value) override { KCheck(::GoSurfaceTool_SetXAnchor(Handle, value)); }
                }

                /// <summary>Gets/Sets the current Y-anchoring source.</summary>
                property k32s YAnchor
                {
                    virtual k32s get() override { return (k32s)::GoSurfaceTool_YAnchor(Handle); }
                    virtual void set(k32s value) override { KCheck(::GoSurfaceTool_SetYAnchor(Handle, value)); }
                }

                /// <summary>Gets/Sets the current Z-anchoring source.</summary>
                property k32s ZAnchor
                {
                    virtual k32s get() override { return (k32s)::GoSurfaceTool_ZAnchor(Handle); }
                    virtual void set(k32s value) override { KCheck(::GoSurfaceTool_SetZAnchor(Handle, value)); }
                }

                /// <summary>Gets/Sets the ZAngle-anchoring source.</summary>
                property k32s ZAngleAnchor
                {
                    virtual k32s get() override { return (k32s)::GoSurfaceTool_ZAngleAnchor(Handle); }
                    virtual void set(k32s value) override { KCheck(::GoSurfaceTool_SetZAngleAnchor(Handle, value)); }
                }
                ...
                virtual k32u GetSourceOption(k64s index) override
                {
                ...
                {
                    virtual kSize get() override { return (kSize)::GoSurfaceTool_SourceOptionCount(Handle); }
                }
                ...
                {
                    virtual bool get() override { return KToBool(::GoSurfaceTool_XAnchorEnabled(Handle)); }
                }

                /// <summary>Gets the X-anchoring option list count.</summary>
                property kSize XAnchorOptionCount
                {
                    virtual kSize get() override { return (kSize)::GoSurfaceTool_XAnchorOptionCount(Handle); }
                }
                ...
                virtual k32u GetXAnchorOptionAt(k64s index) override
                {
                ...
                {
                    virtual bool get() override { return KToBool(::GoSurfaceTool_YAnchorEnabled(Handle)); }
                }

                /// <summary>Gets the Y-anchoring option list count.</summary>
                property kSize YAnchorOptionCount
                {
                    virtual kSize get() override { return (kSize)::GoSurfaceTool_YAnchorOptionCount(Handle); }
                }
                ...
                virtual k32u GetYAnchorOptionAt(k64s index) override
                {
                ...
                {
                    virtual bool get() override { return KToBool(::GoSurfaceTool_ZAnchorEnabled(Handle)); }
                }

                /// <summary>Gets the Z-anchoring option list count.</summary>
                property kSize ZAnchorOptionCount
                {
                    virtual kSize get() override { return (kSize)::GoSurfaceTool_ZAnchorOptionCount(Handle); }
                }
                ...
                virtual k32u GetZAnchorOptionAt(k64s index) override
                {
                ...
                {
                    virtual bool get() override { return KToBool(::GoSurfaceTool_ZAngleAnchorEnabled(Handle)); }
                }

                /// <summary>Gets the Z-anchoring option list count.</summary>
                property kSize ZAngleAnchorOptionCount
                {
                    virtual kSize get() override { return (kSize)::GoSurfaceTool_ZAngleAnchorOptionCount(Handle); }
                }

                /// <summary></summary>
                /// <param name="index">The index of the Z-anchoring option to retrieve.</param>
                /// <returns>A Z-anchoring option.</returns>
                virtual k32u GetZAngleAnchorOptionAt(k64s index) override
                {
