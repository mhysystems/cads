...
namespace Lmi3d
{
    namespace GoSdk
    {
        namespace Tools
        {
            ...
            /// <summary>Represents an Z measurement for a Profile X-Line tool.</summary>
            public ref class GoProfileXLineZ : public GoMeasurement
            {
                KDeclareClass(GoProfileXLineZ, GoProfileXLineZ)

                /// <summary>Initializes a new instance of the GoProfileXLineZ class with the specified Zen object handle.</summary>
                /// <param name="handle">Zen object handle.</param>
                GoProfileXLineZ(IntPtr handle)
                    : GoMeasurement(handle)
                {}
            };

            /// <summary>Represents a validity measurement for a Profile X-Line tool.</summary>
            public ref class GoProfileXLineValidity : public GoMeasurement
            {
                KDeclareClass(GoProfileXLineValidity, GoProfileXLineValidity)

                /// <summary>Initializes a new instance of the GoProfileXLineValidity class with the specified Zen object handle.</summary>
                /// <param name="handle">Zen object handle.</param>
                GoProfileXLineValidity(IntPtr handle)
                    : GoMeasurement(handle)
                {}
            };
            ...
            internal:
                static GoMeasurement^ GetMeasurementInstance(::GoMeasurement measurement)
                {
                    ...
                    if (kObject_Is(measurement, kTypeOf(GoProfileXLineZ))) { return KToObject<GoProfileXLineZ^>(measurement); }
                    if (kObject_Is(measurement, kTypeOf(GoProfileXLineValidity))) { return KToObject<GoProfileXLineValidity^>(measurement); }
