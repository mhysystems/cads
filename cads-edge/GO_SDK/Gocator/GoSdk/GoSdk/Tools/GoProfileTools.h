...
/**
 * @class   GoProfileXLine
 * @extends GoProfileTool
 * @ingroup GoSdk-ProfileTools
 * @brief   Represents a profile X-Line tool.
*/
typedef GoProfileTool GoProfileXLine;

/**
 * Returns the enabled state of the tool region.
 *
 * @public                  @memberof GoProfileXLine
 * @version                 Introduced in firmware 4.3.3.124
 * @param    tool           GoProfileXLine object.
 * @return                  kTRUE if enabled and kFALSE if disabled.
 */
 ...
 * @version                 Introduced in firmware 4.3.3.124
 * @param    tool           GoProfileXLine object.
 * @return                  The maximum tracking speed.(mm/s)
 */
 ...
 * @version             Introduced in firmware 4.3.3.124
 * @param    tool       GoProfileXLine object.
 * @return              A GoProfileXLine Z measurement. (mm)
 */
 ...
 * @version             Introduced in firmware 4.3.3.124
 * @param    tool       GoProfileXLine object.
 * @return              A GoProfileXLine Validity measurement.
 */
GoFx(GoProfileXLineZ) GoProfileXLine_ValidityMeasurement(GoProfileXLine tool);
