...
GoFx(kStatus) GoSurfaceTool_Init(GoSurfaceTool tool, kType type, GoToolType typeId, kObject sensor, kAlloc alloc)
{
    ...
    kCheck(GoExtTool_Init(tool, type, typeId, sensor, alloc));

    obj->base.stream.step = GO_DATA_STEP_SURFACE;
    obj->base.stream.id = 0;
...
GoFx(kStatus) GoSurfaceTool_VRelease(GoSurfaceTool tool)
{
    ...
    return GoExtTool_VRelease(tool);
}
...
GoFx(kSize) GoSurfaceTool_StreamOptionCount(GoSurfaceTool tool)
{
    ...
    GoSensor_SyncConfig(obj->base.base.sensor);

    return kArrayList_Count(obj->base.streamOptions);
}
...
GoFx(GoDataStream) GoSurfaceTool_StreamOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.streamOptions));

    return kArrayList_AsT(obj->base.streamOptions, index, GoDataStream);
}
...
GoFx(kStatus) GoSurfaceTool_SetStream(GoSurfaceTool tool, GoDataStream stream)
{
    ...
    {
        kCheck(GoOptionList_CheckDataStream(kArrayList_DataT(obj->base.streamOptions, const GoDataStream), kArrayList_Count(obj->base.streamOptions), stream));
    }

    obj->base.stream = stream;
...
GoFx(kStatus) GoSurfaceTool_SetSource(GoSurfaceTool tool, GoDataSource source)
{
    ...
    if (GoTools_IsToolInOptionsList(GoSensor_Tools(GoTool_Sensor(tool)), kObject_Type(tool)))
    {
        kCheck(GoOptionList_Check32u(kArrayList_DataT(obj->base.sourceOptions, const k32u), kArrayList_Count(obj->base.sourceOptions), source));
    }

    obj->base.source = source;
    kCheck(GoSensor_SetConfigModified(GoTool_Sensor(tool)));
...
GoFx(kSize) GoSurfaceTool_SourceOptionCount(GoSurfaceTool tool)
{
    ...
    return kArrayList_Count(obj->base.sourceOptions);
}
...
GoFx(k32u) GoSurfaceTool_SourceOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.sourceOptions));

    return kArrayList_AsT(obj->base.sourceOptions, index, k32u);
}
...
GoFx(kSize) GoSurfaceTool_XAnchorOptionCount(GoSurfaceTool tool)
{
    ...
    return kArrayList_Count(obj->base.anchoring.x.options);
}
...
GoFx(k32u) GoSurfaceTool_XAnchorOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.anchoring.x.options));

    return kArrayList_AsT(obj->base.anchoring.x.options, index, k32u);
}
...
GoFx(k32s) GoSurfaceTool_XAnchor(GoSurfaceTool tool)
{
    ...
    return obj->base.anchoring.x.anchor;
}
...
GoFx(kStatus) GoSurfaceTool_SetXAnchor(GoSurfaceTool tool, k32s id)
{
    ...
    {
        obj->base.anchoring.x.used = kTRUE;
        kCheck(GoOptionList_Check32u(kArrayList_DataT(obj->base.anchoring.x.options, const k32u), kArrayList_Count(obj->base.anchoring.x.options), id));
    }

    obj->base.anchoring.x.anchor = id;
    kCheck(GoSensor_SetConfigModified(GoTool_Sensor(tool)));
...
GoFx(kBool) GoSurfaceTool_XAnchorEnabled(GoSurfaceTool tool)
{
    ...
    if (obj->base.anchoring.x.anchor != GO_MEASUREMENT_ID_NONE)
    {
        return kTRUE;
    }
...
GoFx(kSize) GoSurfaceTool_YAnchorOptionCount(GoSurfaceTool tool)
{
    ...
    return kArrayList_Count(obj->base.anchoring.y.options);
}
...
GoFx(k32u) GoSurfaceTool_YAnchorOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.anchoring.y.options));

    return kArrayList_AsT(obj->base.anchoring.y.options, index, k32u);
}
...
GoFx(k32s) GoSurfaceTool_YAnchor(GoSurfaceTool tool)
{
    ...
    return obj->base.anchoring.y.anchor;
}
...
GoFx(kStatus) GoSurfaceTool_SetYAnchor(GoSurfaceTool tool, k32s id)
{
    ...
    if (id != GO_MEASUREMENT_ID_NONE)
    {
        obj->base.anchoring.y.used = kTRUE;
        kCheck(GoOptionList_Check32u(kArrayList_DataT(obj->base.anchoring.y.options, const k32u), kArrayList_Count(obj->base.anchoring.y.options), id));
    }

    obj->base.anchoring.y.anchor = id;
    kCheck(GoSensor_SetConfigModified(GoTool_Sensor(tool)));
...
GoFx(kBool) GoSurfaceTool_YAnchorEnabled(GoSurfaceTool tool)
{
    ...
    if (obj->base.anchoring.y.anchor != GO_MEASUREMENT_ID_NONE)
    {
        return kTRUE;
    }
...
GoFx(kSize) GoSurfaceTool_ZAnchorOptionCount(GoSurfaceTool tool)
{
    ...
    return kArrayList_Count(obj->base.anchoring.z.options);
}
...
GoFx(k32u) GoSurfaceTool_ZAnchorOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.anchoring.z.options));

    return kArrayList_AsT(obj->base.anchoring.z.options, index, k32u);
}
...
GoFx(kStatus) GoSurfaceTool_SetZAnchor(GoSurfaceTool tool, k32s id)
{
    ...
    if (id != GO_MEASUREMENT_ID_NONE)
    {
        obj->base.anchoring.z.used = kTRUE;
        kCheck(GoOptionList_Check32u(kArrayList_DataT(obj->base.anchoring.z.options, const k32u), kArrayList_Count(obj->base.anchoring.z.options), id));
    }

    obj->base.anchoring.z.anchor = id;
    kCheck(GoSensor_SetConfigModified(GoTool_Sensor(tool)));
...
GoFx(kBool) GoSurfaceTool_ZAnchorEnabled(GoSurfaceTool tool)
{
    ...
    if (obj->base.anchoring.z.anchor != GO_MEASUREMENT_ID_NONE)
    {
        return kTRUE;
    }
...
GoFx(k32s) GoSurfaceTool_ZAnchor(GoSurfaceTool tool)
{
    ...
    return obj->base.anchoring.z.anchor;
}
...
GoFx(kSize) GoSurfaceTool_ZAngleAnchorOptionCount(GoSurfaceTool tool)
{
    ...
    return kArrayList_Count(obj->base.anchoring.zAngle.options);
}
...
GoFx(k32u) GoSurfaceTool_ZAngleAnchorOptionAt(GoSurfaceTool tool, kSize index)
{
    ...
    kAssert(index < kArrayList_Count(obj->base.anchoring.zAngle.options));

    return kArrayList_AsT(obj->base.anchoring.zAngle.options, index, k32u);
}
...
GoFx(kStatus) GoSurfaceTool_SetZAngleAnchor(GoSurfaceTool tool, k32s id)
{
    ...
    if (id != GO_MEASUREMENT_ID_NONE)
    {
        obj->base.anchoring.zAngle.used = kTRUE;
        kCheck(GoOptionList_Check32u(kArrayList_DataT(obj->base.anchoring.zAngle.options, const k32u), kArrayList_Count(obj->base.anchoring.zAngle.options), id));
    }

    obj->base.anchoring.zAngle.anchor = id;
    kCheck(GoSensor_SetConfigModified(GoTool_Sensor(tool)));
...
GoFx(kBool) GoSurfaceTool_ZAngleAnchorEnabled(GoSurfaceTool tool)
{
    ...
    if (obj->base.anchoring.zAngle.anchor != GO_MEASUREMENT_ID_NONE)
    {
        return kTRUE;
    }
...
GoFx(k32s) GoSurfaceTool_ZAngleAnchor(GoSurfaceTool tool)
{
    ...
    return obj->base.anchoring.zAngle.anchor;
}
