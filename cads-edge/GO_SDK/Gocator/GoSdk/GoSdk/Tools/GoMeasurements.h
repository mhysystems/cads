...
/**
* @class   GoProfileXLineZ
* @extends GoMeasurement
* @ingroup GoSdk-ProfileTools
* @brief   Represents an Z measurement for a Profile X-Line tool.
*/
typedef GoMeasurement GoProfileXLineZ;

/**
* @class   GoProfileXLineValidity
* @extends GoMeasurement
* @ingroup GoSdk-ProfileTools
* @brief   Represents a validity measurement for a Profile X-Line tool.
*/
typedef GoMeasurement GoProfileXLineValidity;
