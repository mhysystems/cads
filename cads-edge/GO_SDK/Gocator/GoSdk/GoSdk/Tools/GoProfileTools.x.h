...
// TODO: does this profile tool still require support in SDK?
#define GO_PROFILE_TOOL_NAME_XLINE          "ProfileXLine"
...
typedef struct GoProfileXLineClass
{
    GoProfileToolClass base;
    k64f maxTrackingSpeed;
    kBool regionEnabled;
    GoProfileRegion region;
} GoProfileXLineClass;

kDeclareClassEx(Go, GoProfileXLine, GoProfileTool)
