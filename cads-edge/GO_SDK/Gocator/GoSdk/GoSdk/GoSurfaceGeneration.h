...
/** 
 * @deprecated Sets the rotational surface generation surface circumference.
 *
 * @public                  @memberof GoSurfaceGeneration
 * @note                    Supported with G2, G3
 * @version                 Introduced in firmware 4.0.10.27
...
/** 
 * @deprecated Gets the rotational surface generation circumference.
 *
 * @public                  @memberof GoSurfaceGeneration
 * @note                    Supported with G2, G3
 * @version                 Introduced in firmware 4.0.10.27
...
/** 
 * @deprecated Gets the rotational surface generation circumference limit maximum value.
 *
 * @public                  @memberof GoSurfaceGeneration
 * @note                    Supported with G2, G3
 * @version                 Introduced in firmware 4.0.10.27
...
/** 
 * @deprecated Gets the rotational surface generation circumference limit minimum value.
 *
 * @public                  @memberof GoSurfaceGeneration
 * @note                    Supported with G2, G3
 * @version                 Introduced in firmware 4.0.10.27
