...
#if defined(_WINDLL)
#define K_WIN_EXPORT __declspec(dllexport)
#else
#define K_WIN_EXPORT 
#endif
...
#   define kExportFx(TYPE)                  kExtern K_WIN_EXPORT  TYPE kCall
#   define kImportFx(TYPE)                  kExtern K_WIN_EXPORT  TYPE kCall

#   define kExportCx(TYPE)                  kExtern K_WIN_EXPORT  TYPE xkDlCall
#   define kImportCx(TYPE)                  kExtern K_WIN_EXPORT  TYPE xkDlCall

#   define kInFx(TYPE)                      kExtern TYPE kCall
#   define kInCx(TYPE)                      kExtern TYPE kCall

#   define kExportDx(TYPE)                  K_WIN_EXPORT  TYPE
#   define kImportDx(TYPE)                  K_WIN_EXPORT  TYPE

#   define kInDx(TYPE)                      TYPE

#   define kExportClass                     K_WIN_EXPORT 
#   define kImportClass                     K_WIN_EXPORT 
...
#       define kOS_INFINITE    ti_sysbios_BIOS_WAIT_FOREVER
        typedef ti_sysbios_knl_Task_Handle kThreadId; 
