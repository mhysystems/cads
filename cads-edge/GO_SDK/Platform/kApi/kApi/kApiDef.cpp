...
xkBeginVoidValueEx(k, kVoid)
    ...
    kAddPrivateVersion(kVoid, "kdat6", "5.7.1.0", "kVoid-0", Write, Read)
xkEndVoidValueEx()
...
kBeginValueEx(k, k8u)
    ...
    kAddPrivateVersion(k8u, "kdat5", "5.0.0.0", "146-0", Write, Read)
    kAddPrivateVersion(k8u, "kdat6", "5.7.1.0", "k8u-0", Write, Read)
...
kBeginValueEx(k, k16u)
    ...
    kAddPrivateVersion(k16u, "kdat5", "5.0.0.0", "148-0", Write, Read)
    kAddPrivateVersion(k16u, "kdat6", "5.7.1.0", "k16u-0", Write, Read)
...
kBeginValueEx(k, k32u)
    ...
    kAddPrivateVersion(k32u, "kdat5", "5.0.0.0", "150-0", Write, Read)
    kAddPrivateVersion(k32u, "kdat6", "5.7.1.0", "k32u-0", Write, Read)
...
kBeginValueEx(k, k64u)
    ...
    kAddPrivateVersion(k64u, "kdat5", "5.0.0.0", "153-0", Write, Read)
    kAddPrivateVersion(k64u, "kdat6", "5.7.1.0", "k64u-0", Write, Read)
...
kBeginValueEx(k, k8s)
    ...
    kAddPrivateVersion(k8s, "kdat5", "5.0.0.0", "147-0", Write, Read)
    kAddPrivateVersion(k8s, "kdat6", "5.7.1.0", "k8s-0", Write, Read)
...
kBeginValueEx(k, k16s)
    ...
    kAddPrivateVersion(k16s, "kdat5", "5.0.0.0", "149-0", Write, Read)
    kAddPrivateVersion(k16s, "kdat6", "5.7.1.0", "k16s-0", Write, Read)
...
kBeginValueEx(k, k32s)
    ...
    kAddPrivateVersion(k32s, "kdat5", "5.0.0.0", "151-0", Write, Read)
    kAddPrivateVersion(k32s, "kdat6", "5.7.1.0", "k32s-0", Write, Read)
...
kBeginValueEx(k, k64s)
    ...
    kAddPrivateVersion(k64s, "kdat5", "5.0.0.0", "154-0", Write, Read)
    kAddPrivateVersion(k64s, "kdat6", "5.7.1.0", "k64s-0", Write, Read)
...
kBeginValueEx(k, k32f)
    ...
    kAddPrivateVersion(k32f, "kdat5", "5.0.0.0", "152-0", Write, Read)
    kAddPrivateVersion(k32f, "kdat6", "5.7.1.0", "k32f-0", Write, Read)
...
kBeginValueEx(k, k64f)
    ...
    kAddPrivateVersion(k64f, "kdat5", "5.0.0.0", "155-0", Write, Read)
    kAddPrivateVersion(k64f, "kdat6", "5.7.1.0", "k64f-0", Write, Read)
...
kBeginValueEx(k, kByte)
    ...
    kAddPrivateVersion(kByte, "kdat5", "5.0.0.0", "157-0", Write, Read)
    kAddPrivateVersion(kByte, "kdat6", "5.7.1.0", "kByte-0", Write, Read)
...
kBeginValueEx(k, kChar)
    ...
    kAddPrivateVersion(kChar, "kdat5", "5.0.0.0", "158-0", Write, Read)
    kAddPrivateVersion(kChar, "kdat6", "5.7.1.0", "kChar-0", Write, Read)
...
kBeginValueEx(k, kBool)
    ...
    kAddPrivateVersion(kBool, "kdat5", "5.0.0.0", "156-0", Write, Read)
    kAddPrivateVersion(kBool, "kdat6", "5.7.1.0", "kBool-0", Write, Read)
...
kBeginValueEx(k, kSize)
    ...
    kAddPrivateVersion(kSize, "kdat6", "5.7.1.0", "kSize-0", Write, Read)
...
kBeginValueEx(k, kSSize)
    ...
    kAddPrivateVersion(kSSize, "kdat6", "5.7.1.0", "kSSize-0", Write, Read)
...
kBeginArrayValueEx(k, kText16, kChar)
    kAddPrivateVersion(kText16, "kdat5", "5.0.0.0", "171-0", Write, Read)
    kAddPrivateVersion(kText16, "kdat6", "5.7.1.0", "kText16-0", Write, Read)
...
kBeginArrayValueEx(k, kText32, kChar)
    kAddPrivateVersion(kText32, "kdat5", "5.0.0.0", "172-0", Write, Read)
    kAddPrivateVersion(kText32, "kdat6", "5.7.1.0", "kText32-0", Write, Read)
...
kBeginArrayValueEx(k, kText64, kChar)
    kAddPrivateVersion(kText64, "kdat5", "5.0.0.0", "173-0", Write, Read)
    kAddPrivateVersion(kText64, "kdat6", "5.7.1.0", "kText64-0", Write, Read)
...
kBeginArrayValueEx(k, kText128, kChar)
    kAddPrivateVersion(kText128, "kdat5", "5.0.0.0", "174-0", Write, Read)
    kAddPrivateVersion(kText128, "kdat6", "5.7.1.0", "kText128-0", Write, Read)
...
kBeginArrayValueEx(k, kText256, kChar)
    kAddPrivateVersion(kText256, "kdat5", "5.0.0.0", "175-0", Write, Read)
    kAddPrivateVersion(kText256, "kdat6", "5.7.1.0", "kText256-0", Write, Read)
...
kBeginEnumEx(k, kStatus)
    ...
    kAddPrivateVersion(kStatus, "kdat6", "5.7.1.0", "kStatus-0", Write, Read)
...
kBeginValueEx(k, kVersion)
    ...
    kAddPrivateVersion(kVersion, "kdat6", "5.7.1.0", "kVersion-0", Write, Read)
...
kBeginValueEx(k, kPoint16s)
    kAddPrivateVersion(kPoint16s, "kdat5", "5.0.0.0", "161-0", Write, Read)
    kAddPrivateVersion(kPoint16s, "kdat6", "5.7.1.0", "kPoint16s-0", Write, Read)
...
kBeginValueEx(k, kPoint32s)
    kAddPrivateVersion(kPoint32s, "kdat5", "5.0.0.0", "162-0", Write, Read)
    kAddPrivateVersion(kPoint32s, "kdat6", "5.7.1.0", "kPoint32s-0", Write, Read)
...
kBeginValueEx(k, kPoint32f)
    kAddPrivateVersion(kPoint32f, "kdat5", "5.0.0.0", "163-0", Write, Read)
    kAddPrivateVersion(kPoint32f, "kdat6", "5.7.1.0", "kPoint32f-0", Write, Read)
...
kBeginValueEx(k, kPoint64f)
    kAddPrivateVersion(kPoint64f, "kdat5", "5.0.0.0", "165-0", Write, Read)
    kAddPrivateVersion(kPoint64f, "kdat6", "5.7.1.0", "kPoint64f-0", Write, Read)
...
kBeginValueEx(k, kPoint3d16s)
    kAddPrivateVersion(kPoint3d16s, "kdat5", "5.0.0.0", "194-0", Write, Read)
    kAddPrivateVersion(kPoint3d16s, "kdat6", "5.7.1.0", "kPoint3d16s-0", Write, Read)
...
kBeginValueEx(k, kPoint3d32s)
    kAddPrivateVersion(kPoint3d32s, "kdat5", "5.0.0.0", "164-0", Write, Read)
    kAddPrivateVersion(kPoint3d32s, "kdat6", "5.7.1.0", "kPoint3d32s-0", Write, Read)
...
kBeginValueEx(k, kPoint3d32f)
    kAddPrivateVersion(kPoint3d32f, "kdat5", "5.0.0.0", "195-0", Write, Read)
    kAddPrivateVersion(kPoint3d32f, "kdat6", "5.7.1.0", "kPoint3d32f-0", Write, Read)
...
kBeginValueEx(k, kPoint3d64f)
    kAddPrivateVersion(kPoint3d64f, "kdat5", "5.0.0.0", "196-0", Write, Read)
    kAddPrivateVersion(kPoint3d64f, "kdat6", "5.7.1.0", "kPoint3d64f-0", Write, Read)
...
kBeginValueEx(k, kPoint4d16s)
    kAddPrivateVersion(kPoint4d16s, "kdat6", "5.7.1.0", "kPoint4d16s-0", Write, Read)
...
kBeginValueEx(k, kRect16s)
    kAddPrivateVersion(kRect16s, "kdat6", "5.7.1.0", "kRect16s-0", Write, Read)
...
kBeginValueEx(k, kRect32s)
    kAddPrivateVersion(kRect32s, "kdat5", "5.0.0.0", "166-0", Write, Read)
    kAddPrivateVersion(kRect32s, "kdat6", "5.7.1.0", "kRect32s-0", Write, Read)
...
kBeginValueEx(k, kRect32f)
    kAddPrivateVersion(kRect32f, "kdat5", "5.0.0.0", "167-0", Write, Read)
    kAddPrivateVersion(kRect32f, "kdat6", "5.7.1.0", "kRect32f-0", Write, Read)
...
kBeginValueEx(k, kRect64f)
    kAddPrivateVersion(kRect64f, "kdat5", "5.0.0.0", "168-0", Write, Read)
    kAddPrivateVersion(kRect64f, "kdat6", "5.7.1.0", "kRect64f-0", Write, Read)
...
kBeginValueEx(k, kRect3d64f)
    kAddPrivateVersion(kRect3d64f, "kdat6", "6.0.14.0", "kRect3d64f-0", Write, Read)
...
kBeginValueEx(k, kRotatedRect32s)
    kAddPrivateVersion(kRotatedRect32s, "kdat5", "5.0.0.0", "169-0", Write, Read)
    kAddPrivateVersion(kRotatedRect32s, "kdat6", "5.7.1.0", "kRotatedRect32s-0", Write, Read)
...
kBeginValueEx(k, kRotatedRect32f)
    kAddPrivateVersion(kRotatedRect32f, "kdat5", "5.0.0.0", "170-0", Write, Read)
    kAddPrivateVersion(kRotatedRect32f, "kdat6", "5.7.1.0", "kRotatedRect32f-0", Write, Read)
...
kBeginEnumEx(k, kPixelFormat)
    kAddPrivateVersion(kPixelFormat, "kdat6", "5.7.1.0", "kPixelFormat-0", Write, Read)
...
kBeginEnumEx(k, kCfa)
    kAddPrivateVersion(kCfa, "kdat6", "5.7.1.0", "kCfa-0", Write, Read)
...
kBeginValueEx(k, kRgb)
    kAddPrivateVersion(kRgb, "kdat5", "5.0.0.0", "179-0", Write, Read)
    kAddPrivateVersion(kRgb, "kdat6", "5.7.1.0", "kRgb-0", Write, Read)
...
kBeginValueEx(k, kArgb)
    kAddPrivateVersion(kArgb, "kdat5", "5.0.0.0", "180-0", Write, Read)
    kAddPrivateVersion(kArgb, "kdat6", "5.7.1.0", "kArgb-0", Write, Read)
