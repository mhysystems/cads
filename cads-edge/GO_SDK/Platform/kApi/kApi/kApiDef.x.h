...
#define xkAddPrivateVersion(TYPE, FORMAT, FORMAT_VER, GUID, WRITE_METHOD, READ_METHOD)      \
    ...
    (kFunction)x##TYPE##_##WRITE_METHOD, (kFunction)x##TYPE##_##READ_METHOD));
...
kForwardDeclareClass(k, kAlloc, kObject)
...
/* 
 * Misc copy/reverse utils, not widely used anymore, may be removed at some point.
*/
