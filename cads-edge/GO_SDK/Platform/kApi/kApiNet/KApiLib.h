...
namespace Lmi3d
{
    namespace Zen
    {
        ...
        kStatus kCall KApiLib_OnAlloc(kPointer provider, kSize size, void* mem); 
        ...
        internal:
            ...
            static kSize MemHeaderSize = kDivideCeilUInt_(sizeof(kSize), kALIGN_ANY_SIZE) * kALIGN_ANY_SIZE; 

            delegate kStatus KAllocFx(kPointer provider, kSize size, void* mem);
