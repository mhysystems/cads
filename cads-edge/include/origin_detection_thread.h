...
namespace cads
{
  ...
  void splice_detection_thread(double x_resolution, double y_resolution, int width_n, moodycamel::BlockingReaderWriterQueue<msg> &profile_fifo, moodycamel::BlockingReaderWriterQueue<msg> &next_fifo);
}